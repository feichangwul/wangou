	...
	<table class="tablesorter left" cellspacing="0" width="100%">
		...
		<tbody>
			...
			<tr>
				<td>系统彩种利润</td>
				<td>
					<label><input type="radio" value="2" name="LiRunLv" <?=$this->iff($this->settings['LiRunLv'],'checked="checked"')?>/>高</label>
					<label><input type="radio" value="0" name="LiRunLv" <?=$this->iff(!$this->settings['LiRunLv'],'checked="checked"')?>/>低</label>
					<label>&nbsp&nbsp&nbsp&nbsp当期投注人数小于<input type="text" class="textWid1" value="<?=$this->settings['liRuncount']?>" name="liRuncount"/>人则随机出号，否则利率开奖</label>
				</td>
			</tr>
			<tr>
				<td>会员上榜最低中奖金额</td>
