...
<table width="100%" border="0" cellspacing="1" cellpadding="4" class='table_b'>
 ...
 <? if ($memberBank['bankName']=="支付宝"){  ?>
    <td align="left" ><img id="bank-type-icon" class="bankimg2"    src="/upload/bank-icons/zhifubaoerweima.png" title="支付宝" />
          
                            </td> 


<? }else if ($memberBank['bankName']=="微信"){  ?>
    <td align="left" ><img id="bank-type-icon" class="bankimg2" src="/upload/bank-icons/weixinerweima.png" title="微信" />
