...
<table width="100%" border="0" cellspacing="1" cellpadding="4" class='table_b'>
    ...
    <strong style="color:green;font-size:16px;"><?=$this->settings['cashMax']?></strong>&nbsp&nbsp元。</p>
	</td> 
    </tr>
	<tr height=25 class='table_b_tr_b' >
    ...
    <tr height=25 class='table_b_tr_b' >
      ...
      <td align="left" ><input  readonly value="<?=preg_replace('/^.*(\w{4})$/', '***\1', htmlspecialchars($bank['account']))?>" /></td> 
    </tr>
     <tr height=25 class='table_b_tr_b'>
      <td align="right" class="copys">账户名：</td>
      <td align="left" ><input readonly value="<?=preg_replace('/^(\w).*$/', '\1**', htmlspecialchars($bank['username']))?>" /></td> 
    </tr>
     <tr height=25 class='table_b_tr_b'>
